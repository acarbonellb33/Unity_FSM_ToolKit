...
namespace EditorWindow.FSMSystem.Elements
{
    ...
    public class FSMStateNode : FSMNode
    {
        ...
        public override void Draw()
        {
            ...
            showPopupToggle.RegisterValueChangedCallback(evt => { ShowAnimatorParameterDropdown(showPopupToggle); });
            ...
            foreach (string attribute in attributes)
            {
                ...
                switch (result[1])
                {
                    ...
                    case "System.Collections.Generic.List`1[System.String]":
                        ...
                        if (inputList != "")
                        {
                            List<GameObject> outputGameObjectsList = inputList.Split('/')
        ...
        private void CreateAndAddGameObject(ObjectField objectListField)
        {
            ...
            if (script != null)
            {
                BehaviorScript newScriptInstance = (BehaviorScript)GameObject.Find(graphContainerData.GameObject)
                    .GetComponent(Type.GetType(graphContainerData.FileName));
        ...
        private void RemovePatrolPoint(ObjectField objectListField)
        {
            ...
            {
                BehaviorScript newScriptInstance = (BehaviorScript)GameObject.Find(graphContainerData.GameObject)
                    .GetComponent(Type.GetType("EditorWindow.FSMSystem.BehaviorScripts."+graphContainerData.FileName));
        ...
        private void ShowAnimatorParameterDropdown(Toggle toggle)
        {
            ...
            dropdown.RegisterValueChangedCallback(evt =>
            {
                ...
                if (parameterType == "Float")
                {
                    ...
                    floatField.RegisterCallback<ChangeEvent<float>>(e => { _animatorValue = e.newValue.ToString(); });
            ...
            if (animator != null)
            {
                switch (parameterType)
                {
                    ...
                    case "Float":
                        ...
                        Debug.Log("Parameter name: " + parameterName + " Value: " + value + " Parameter Type: " +
                                  parameterType);
                        break;
                    case "Integer":
