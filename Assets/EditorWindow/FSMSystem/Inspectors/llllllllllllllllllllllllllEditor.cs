...
using UnityEngine;
[CustomEditor(typeof(llllllllllllllllllllllllll))]
public class llllllllllllllllllllllllllEditor : Editor
{
	...
	void OnEnable()
	{
		...
		llllllllllllllllllllllllll llllllllllllllllllllllllll = (llllllllllllllllllllllllll)target;
		for (int i = 0; i < llllllllllllllllllllllllll.options.Count; i++)
		{
			optionToObjectMap[llllllllllllllllllllllllll.options[i].GetStateName()] = llllllllllllllllllllllllll.options[i];
		}
	}
	public override void OnInspectorGUI()
	{
		...
		llllllllllllllllllllllllll llllllllllllllllllllllllll = (llllllllllllllllllllllllll)target;
		string[] options = new string[llllllllllllllllllllllllll.options.Count];
		for (int i = 0; i < options.Length; i++)
		{
			options[i] = llllllllllllllllllllllllll.options[i].GetStateName();
		}
		...
		if (optionToObjectMap.ContainsKey(selectedOptionName))
		{
			...
			StateScript selectedObject = optionToObjectMap[selectedOptionName.Split(' ')[0]];
			...
			while (nextVisible)
			{
				if (iterator.name != "m_Script")
				{
					...
					if (EditorGUI.EndChangeCheck())
					{
						...
						FSMIOUtility.CreateJson(selectedObject, "llllllllllllllllllllllllll");
					}
				}
